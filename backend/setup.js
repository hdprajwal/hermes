...
sequelize.sync({force: true})
         .then(()=>{
             ...
             sequelize.query('ALTER TABLE login_log ADD FOREIGN KEY(userid) REFERENCES users(uid) ON DELETE CASCADE;')
             .then(()=>console.log("login_log foreign key setup done."))
             .catch((err)=>console.log(err));
             sequelize.query('ALTER TABLE chat_log ADD FOREIGN KEY(from_i_d) REFERENCES users(uid) ON DELETE CASCADE;')
